...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{url('home')}}" class="logo">
            ...
            <span class="logo-lg">{{trans('lang.title')}}</span>
        </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-right">
                                    ...
                                    <button class="btn btn-primary" type="submit">{{trans('lang.log_out')}}</button>
                                    {!! Form::close() !!}
                                </div>
                            </li>
                        </ul>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="{{url(route('governrates.index'))}}"><i class="fa fa-map-marker"></i> <span>{{trans('lang.governorates')}}</span></a></li>
                <li><a href="{{url(route('cities.index'))}}"><i class="fa fa-flag"></i> <span>{{trans('lang.cities')}}</span></a></li>
                <li><a href="{{url(route('categories.index'))}}"><i class="fa fa-list"></i> <span>{{trans('lang.categories')}}</span></a></li>
